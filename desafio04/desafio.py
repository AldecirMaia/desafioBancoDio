...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n @@@ Operação falhou!!! Voce nao tem saldo o suficiente. @@@")
        elif valor > 0:
            self.saldo -= valor
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("\n @@@ A quantidade de Saques diarios já foi atingida @@@")
        elif excedeu_saques:
            print("\n @@@ A quantidade de Saques Diaria foi atingida @@@")
        else:
...
def recuperar_conta_cliente(cliente):
    if not cliente.contas:
        print("\n @@@ O cliente ainda não possui conta no nosso Banco! @@@")
        return
